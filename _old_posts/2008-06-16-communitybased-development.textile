...
<ul>
<li>Mailing lists - Dev, Announcements, Users, Builds, etc.
<li>RSS feeds - Tie into mailing lists, issue tracking
<li>Issue Tracking
<li>SCM
<li>Wiki
<li>Search (projects and code)
<li>Admin Management (Users, Roles, Project setup, etc.)
<li>Web Site
</ul>
...
<h2>References</h2>
<ul>
<li>[1] The Cathedral and the Bazaar, by Eric S. Raymond (<a href="http://www.catb.org/~esr/writings/cathedral-bazaar/cathedral-bazaar/">http://www.catb.org/~esr/writings/cathedral-bazaar/cathedral-bazaar/</a>)
<li>[2] Producing Open Source Software by Karl Fogel (<a href="http://producingoss.com">http://producingoss.com</a>)
<li>[3] SourceForge (<a href="http://www.sourceforge.net">http://www.sourceforge.net</a>)
<li>[4] Java.net (<a href="http://www.java.net">http://www.java.net</a>)
<li>[5] Redmine (<a href="http://www.redmine.org">http://www.redmine.org</a>)
</ul>
</div>
